...
Original file is located at
    https://colab.research.google.com/drive/1YeghS8ZCGvFc9J28tmQCU3YO0CSJ5rQV
"""
...
# Load pretrained DenseNet model and modify the classifier
...
densenet.classifier = nn.Linear(num_features, len(classes))
...
optimizer = optim.SGD(densenet.classifier.parameters(), lr=lr)
...
# Train the model
train(densenet, train_loader, optimizer, criterion, epochs)

# Evaluate on training data
train_accuracy, _, _ = evaluate(densenet, train_loader)
print(f"Accuracy on training data: {train_accuracy:.2f}%")

# Evaluate on test data
test_accuracy, actual_labels, predicted_labels = evaluate(densenet, test_loader)
