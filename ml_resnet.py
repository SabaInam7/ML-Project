...
Original file is located at
    https://colab.research.google.com/drive/1_KVLY8hyrfwvUVuoq1sl_TIo86JfccUH
"""
...
optimizer = optim.SGD(resnet.fc.parameters(), lr=lr)
...
# Train the model
train(resnet, train_loader, optimizer, criterion, epochs)

# Evaluate on training data
train_accuracy, _, _ = evaluate(resnet, train_loader)
print(f"Accuracy on training data: {train_accuracy:.2f}%")

# Evaluate on test data
test_accuracy, actual_labels, predicted_labels = evaluate(resnet, test_loader)
